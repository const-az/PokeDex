...
function printAll(pokemon) {
  $("#pokemon-cards")[0].innerHTML ="";
  pokemon.forEach(p => {
    card =
          "<div class='col s4 m2 xl1 min-carta-pokemon' id='min-carta-"+p.entry_number+"'>"+
  ...
  $("#pokemon-cards")[0].innerHTML += card;
    });
}
...
function printById(id) {
  ...
  $.get("https://pokeapi.co/api/v2/pokemon/" + id, data => {
    $("#singlePokemon")[0].innerHTML ="";

    card =
          "<div class='row' id='carta'>"+
            "<button id='button-cerrar' onclick='closeCard()'><i class='fas fa-times'></i></button>"+
            "<div class='col s12 m6 l3' id='carta-img'>"+
              "<img src='https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/"+data.id+".png'>"+
            "</div>"+

            "<div class='col s12 m6 l4' id='carta-datos'>"+
            ...
            "<div class='col s12 l5' id='carta-graph'>"+
    ...
    $("#singlePokemon")[0].innerHTML = card;
